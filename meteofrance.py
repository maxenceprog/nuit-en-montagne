...
print(client.get_forecast(45.011304,6.324587).raw_data)

# Search a location from name.
list_places = client.search_places("Grenoble")
my_place = list_places[0]

# Fetch weather forecast for the location
my_place_weather_forecast = client.get_forecast_for_place(my_place)

print(my_place_weather_forecast)
